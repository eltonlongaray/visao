...
export function renderWelcome(app) {
  app.innerHTML = `
    <div class="onboarding">
      <div class="onboarding-logo" style="background:#4f46e5"><img src="icons/icon-192.png?v=94" style="width:100%;height:100%;object-fit:cover;border-radius:inherit;display:block;"></div>
